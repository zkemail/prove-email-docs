...
[Account Recovery](account-recovery-api.md): Explains the interfaces to call account recovery functions from a frontend API, to enable and trigger recovery on any Safe or 7579-compatible wallet.
